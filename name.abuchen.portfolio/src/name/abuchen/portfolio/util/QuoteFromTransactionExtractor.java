    ...
    public boolean extractQuotes(Security security)
    {
        ...
        for (TransactionPair<?> p : security.getTransactions(client))
        {
            ...
            if (t instanceof PortfolioTransaction pt)
            {
                ...
                /*
                 * Transactions of multiplier-based instruments contain the
                 * contract value in their gross amount. Therefore the gross
                 * price per share contains the multiplier as well. Security
                 * prices, however, must remain the raw market quote. Valuation
                 * and exposure apply the multiplier separately.
                 */
